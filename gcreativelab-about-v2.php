						...
						<div class="about-container">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide slide-about">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about_v2/image_01.jpg" height="100%" width="100%" style="height: 100%; padding: 0;" alt="">
								</div>
                                ...
                                <div class="swiper-slide about__slide__fifty__left_2" style="padding-right: 0 !important;">
									...
									<div class="about__content__description">
                                    From advertising and creative design, well-grounded strategy and brand development, to digital to social media expertise, signature printing solutions, and corporate communications, our comprehensive range of services are tailored to address the evolving needs of our diverse clients.</div>
                                </div>
