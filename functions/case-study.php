...
function case_study() { 
	...
	register_post_type( 'case-study', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	...
	*/
    ...
    // 	array('case-study'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
